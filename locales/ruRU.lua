...
Если эта опция включена, то свечение будет появляться когда оставшееся
время ауры меньше, чем выбранный процент от максимальной длительности ауры.
Это может быть полезно если, например, вы хотите знать, когда можно
безопасно переприменить ДоТ-заклинание без потери его длительности.

Если эта опция выключена, то свечение будет появляться когда оставшееся
время ауры меньше, чем абсолютное значение на слайдере (в секундах).]];
L["options:spells:animation-relative:tooltip"] = 
[[Эта опция изменяет смысл слайдера слева.

Если эта опция включена, то анимация будет появляться когда оставшееся
время ауры меньше, чем выбранный процент от максимальной длительности ауры.
Это может быть полезно если, например, вы хотите знать, когда можно
безопасно переприменить ДоТ-заклинание без потери его длительности.
